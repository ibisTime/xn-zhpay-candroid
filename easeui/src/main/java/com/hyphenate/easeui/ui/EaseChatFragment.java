...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public static String otherPhoto;
...
//    protected int[] itemStrings = { R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location };
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        myPhoto = fragmentArgs.getString("myPhoto");
        otherPhoto = fragmentArgs.getString("otherPhoto");
    ...
    protected void setUpView() {
        ...
        if(fragmentArgs.getString("nickName").equals("客服")){
            titleBar.setHumanVisibility(View.VISIBLE);
        }else{
            titleBar.setHumanVisibility(View.GONE);
        }
        titleBar.setTitleColor(getResources().getColor(R.color.fontColor_gray));
        titleBar.setBackgroundColor(getResources().getColor(R.color.btn_register_normal));
        ...
        titleBar.setHumanViewClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                EMMessage message = EMMessage.createTxtSendMessage("转人工", toChatUsername);
                sendMessage(message);
            }
        });
