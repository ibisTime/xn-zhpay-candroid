...
public class EaseTitleBar extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        humanView = (TextView) findViewById(R.id.human);
    ...
    public void setHumanViewClickListener(OnClickListener listener){
        humanView.setOnClickListener(listener);
    }
    ...
    public void setHumanVisibility(int visibility){
        humanView.setVisibility(visibility);
    }
