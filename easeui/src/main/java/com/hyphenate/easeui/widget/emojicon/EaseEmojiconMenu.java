...
public class EaseEmojiconMenu extends EaseEmojiconMenuBase{
	...
	private void init(Context context, AttributeSet attrs){
        ...
        emojiconColumns = ta.getInt(R.styleable.EaseEmojiconMenu_emojiconColumn, defaultColumns);
        int defaultBigColumns = 4;
        bigEmojiconColumns = ta.getInt(R.styleable.EaseEmojiconMenu_bigEmojiconRow, defaultBigColumns);
		ta.recycle();
