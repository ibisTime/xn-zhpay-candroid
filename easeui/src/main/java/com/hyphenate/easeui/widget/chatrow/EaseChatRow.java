...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct() == Direct.SEND){
            EaseUserUtils.setUserAvatar(context, userAvatarView, EaseChatFragment.myPhoto);
        }else{
            EaseUserUtils.setUserAvatar(context, userAvatarView, EaseChatFragment.otherPhoto);
