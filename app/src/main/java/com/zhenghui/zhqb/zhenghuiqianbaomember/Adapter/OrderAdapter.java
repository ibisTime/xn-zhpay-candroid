...
//        });
    ...
    public void setView(int position) {
        ...
        ImageUtil.glide(list.get(position).getProductOrderList().get(0).getAdvPic(), holder.imgGood, context);

        holder.txtName.setText(list.get(position).getProductOrderList().get(0).getProductName());
    ...
    private void setTotalPrice(int position) {
        ...
        // 购物币总价
        int gwb = list.get(position).getAmount2();
        // 钱包币总价
        int qbb = list.get(position).getAmount3();
