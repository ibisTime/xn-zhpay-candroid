...
public class StockPayActivity extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stock_pay);
            ...
            case R.id.txt_pay:
                ...
                if (!edtPrice.getText().toString().toString().equals("")) {
                    if (Double.parseDouble(edtPrice.getText().toString().trim()) == 0.0) {
                        Toast.makeText(StockPayActivity.this, "金额必须大于等于0.01元", Toast.LENGTH_SHORT).show();
                    } else {
...
//                        }
                    ...
                    Toast.makeText(StockPayActivity.this, "请输入消费金额", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private void getIp() {
        ...
        x.http().get(params, new Callback.CacheCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                Toast.makeText(StockPayActivity.this, "无法连接服务器，请检查网络", Toast.LENGTH_SHORT).show();
            }
        ...
        new Xutil().post("808403", object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if(payWay.equals("1")){
                        Toast.makeText(StockPayActivity.this, "购买成功", Toast.LENGTH_SHORT).show();
                    }else if(payWay.equals("2")){
                        if(WxUtil.check(StockPayActivity.this)){
                            WxUtil.pay(StockPayActivity.this,jsonObject);
                        }
                    }else {
                ...
                setResult(0, new Intent().putExtra("isPay", true));
                finish();
            }

            @Override
            public void onTip(String tip) {
                Toast.makeText(StockPayActivity.this, tip, Toast.LENGTH_SHORT).show();
            }
