...
public class MapNaviActivity extends MyBaseActivity implements AMapNaviViewListener,AMapNaviListener {
    ...
    public void onInitNaviSuccess() {
        ...
        System.out.println("result="+mAMapNavi.calculateDriveRoute(eList, mWayPointList, strategy));
