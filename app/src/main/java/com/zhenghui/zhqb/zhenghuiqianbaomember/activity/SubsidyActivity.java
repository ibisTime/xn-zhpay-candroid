...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808457;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808458;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808459;
    ...
    private void getLimit(final int num) {
        ...
        new Xutil().post(CODE_808458, object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            public void onSuccess(String result) {
                try {
                    JSONObject jsonObject = new JSONObject(result);
                    txtTurnover.setText(MoneyUtil.moneyFormatDouble(num - jsonObject.getDouble("costAmount")));
