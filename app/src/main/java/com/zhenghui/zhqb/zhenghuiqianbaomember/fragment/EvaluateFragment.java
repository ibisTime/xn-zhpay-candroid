...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808029;
...
public class EvaluateFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RefreshLayout.OnLoadListener {
    ...
    public void getDatas() {
        ...
        new Xutil().post(CODE_808029, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
