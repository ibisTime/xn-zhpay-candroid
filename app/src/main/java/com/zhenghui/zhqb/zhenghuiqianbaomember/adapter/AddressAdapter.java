...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805161;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805163;
...
public class AddressAdapter extends BaseAdapter {
    ...
    private void setDefaultAddress(final int position) {
        ...
        new Xutil().post(CODE_805163, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {

                AddressSelectActivity.instances.getData(true);
...
//            object.put("userId", userInfoSp.getString("userId", null));
        ...
        new Xutil().post(CODE_805161, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {

                AddressSelectActivity.instances.getData(false);
