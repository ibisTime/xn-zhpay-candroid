...
public class StockAdapter extends RecyclerView.Adapter<StockAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_stock, null);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        if(list.get(position).isChoose()){
            ...
            holder.mTextView.setBackground(context.getResources().getDrawable(R.drawable.border_stock_orange));
        }else{
            holder.mTextView.setTextColor(context.getResources().getColor(R.color.fontColor_support));
            holder.mTextView.setBackground(context.getResources().getDrawable(R.drawable.border_stock_gray));
        }
        holder.mTextView.setText((list.get(position).getPrice()/1000)+"");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view,MyItemClickListener mListener) {
            super(view);
            mTextView = (TextView) view.findViewById(R.id.txt_money);
