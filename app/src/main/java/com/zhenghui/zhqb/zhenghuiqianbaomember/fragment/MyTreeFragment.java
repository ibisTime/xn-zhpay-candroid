...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_615119;
...
//                    Toast.makeText(getActivity(), "解析结果:" + result, Toast.LENGTH_LONG).show();
    ...
    private void getData() {
        ...
        new Xutil().post(CODE_615119, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
