...
public class DuoBaoPayActivity extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duo_bao_pay);
        ...
        x.http().get(params, new Callback.CacheCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    joinIn(jsonObject.getString("ip"));
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                Toast.makeText(DuoBaoPayActivity.this, "无法连接服务器，请检查网络", Toast.LENGTH_SHORT).show();
            }
        ...
        new Xutil().post("808303", object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (payWay.equals("1")) {
                        Toast.makeText(DuoBaoPayActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        finish();
                    } else if (payWay.equals("2")) {
                        JSONObject jsonObject = new JSONObject(result);
                        if (WxUtil.check(DuoBaoPayActivity.this)) {
                            WxUtil.pay(DuoBaoPayActivity.this, jsonObject);
                        }
            ...
            public void onTip(String tip) {
                Toast.makeText(DuoBaoPayActivity.this, tip, Toast.LENGTH_LONG).show();
            }
    ...
    public void getDatas() {
        ...
        new Xutil().post("808312", object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            @Override
            public void onTip(String tip) {
                Toast.makeText(DuoBaoPayActivity.this, tip, Toast.LENGTH_SHORT).show();
            }
    ...
    private void setView() {
        // 人民币总价
        double rmb = model.getPrice1() * number;
        // 购物币总价
        int gwb = model.getPrice2() * number;
        // 钱包币总价
        int qbb = model.getPrice3() * number;
