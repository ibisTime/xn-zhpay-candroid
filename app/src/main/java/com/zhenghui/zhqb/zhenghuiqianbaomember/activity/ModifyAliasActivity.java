...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805075;
...
public class ModifyAliasActivity extends MyBaseActivity {
    ...
    public void modifyAlias() {
        ...
        new Xutil().post(CODE_805075, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
