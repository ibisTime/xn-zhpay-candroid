...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805160;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805162;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805166;
...
public class AddAddressActivity extends MyBaseActivity {
    ...
    private void setAddress() {
        ...
        new Xutil().post(CODE_805160, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
                ...
                finish();
                if (isFirst) {
                    AddressSelectActivity.instances.finish();
                }
            }
    ...
    private void modifiAddress() {
        ...
        new Xutil().post(CODE_805162, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
    ...
    private void getAddressDetail() {
        ...
        new Xutil().post(CODE_805166, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
