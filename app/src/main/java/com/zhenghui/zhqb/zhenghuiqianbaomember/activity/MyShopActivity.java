...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808245;
...
public class MyShopActivity extends MyBaseActivity implements SwipeRefreshLayout.OnRefreshListener, RefreshLayout.OnLoadListener,AdapterView.OnItemClickListener {
    ...
    private void getDatas() {
        ...
        new Xutil().post(CODE_808245, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
