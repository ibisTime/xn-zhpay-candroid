...
public class DiscountActivity extends MyBaseActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (isShop) {
            ...
            System.out.println("list.get(i).getTicketKey1()="+list.get(i).getTicketKey1());

            if(money >= list.get(i).getTicketKey1()){
                String ticketName = "满"+(list.get(i).getTicketKey1()/1000)+"减"+(list.get(i).getTicketKey2()/1000);
                setResult(0,new Intent().putExtra("ticketName",ticketName)
                        .putExtra("key1",list.get(i).getTicketKey1())
                        .putExtra("key2",list.get(i).getTicketKey2())
    ...
    private void getList() {
        ...
        new Xutil().post("808228", object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
