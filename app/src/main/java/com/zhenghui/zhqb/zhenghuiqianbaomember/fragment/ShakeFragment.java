...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_615117;
...
//            }
    ...
    private void postLocation() {
        ...
        new Xutil().post(CODE_615117, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
