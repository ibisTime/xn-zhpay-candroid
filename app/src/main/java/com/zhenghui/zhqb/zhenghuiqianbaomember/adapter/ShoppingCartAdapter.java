...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808041;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808042;
...
public class ShoppingCartAdapter extends BaseAdapter {
    ...
    private void deleteSingleProduct(final int position) {
        ...
        new Xutil().post(CODE_808041, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
    ...
    private void modifyProductNum(final int position) {
        ...
        new Xutil().post(CODE_808042, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
                notifyDataSetChanged();
                activity.getTotalPrice();
