...
public class RelationActivity extends MyBaseActivity {
    ...
    private void init() {
        ...
        txtReferrer.setText(userReferee);
    ...
    @OnClick({R.id.layout_back, R.id.layout_level1, R.id.layout_level2, R.id.layout_level3})
    ...
    public void getReferee() {
        ...
        new Xutil().post("805800", object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
