...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805045;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805057;
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_805904;
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_confirm:
                ...
                if (edtPassword.getText().toString().trim().length() < 6) {
                    Toast.makeText(ModifyTradeActivity.this, "密码不能少于6位", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (!edtPassword.getText().toString().trim().equals(edtRepassword.getText().toString().trim())) {
                    Toast.makeText(ModifyTradeActivity.this, "两次输入的密码不相同", Toast.LENGTH_SHORT).show();
                    return;
                }
