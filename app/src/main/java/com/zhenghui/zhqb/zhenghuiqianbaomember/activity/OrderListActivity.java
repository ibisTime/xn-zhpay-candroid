...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_808068;
...
public class OrderListActivity extends MyBaseActivity implements AdapterView.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener, RefreshLayout.OnLoadListener {
    ...
    @OnClick({R.id.layout_back, R.id.layout_all, R.id.layout_waitPay, R.id.layout_waitGet,
            R.id.layout_waitConfirm, R.id.layout_done})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_done:
                ...
                layoutDone.setBackgroundColor(getResources().getColor(R.color.white));
    ...
    private void initBtn() {
        ...
        layoutDone.setBackgroundColor(getResources().getColor(R.color.grayfa));
        ...
        lineDone.setVisibility(View.INVISIBLE);
    }
