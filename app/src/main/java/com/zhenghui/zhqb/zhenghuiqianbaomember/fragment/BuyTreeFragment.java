...
import static com.zhenghui.zhqb.zhenghuiqianbaomember.util.Constants.CODE_615105;
...
public class BuyTreeFragment extends Fragment {
    ...
    public void getTree(){
        ...
        new Xutil().post(CODE_615105, object.toString(), new Xutil.XUtils3CallBackPost() {
            @Override
            public void onSuccess(String result) {
