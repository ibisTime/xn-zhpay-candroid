...
public class ShoppingCartActivity extends MyBaseActivity {
            ...
            case R.id.txt_pay:
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (list.get(i).isChoose()) {
                        ...
                        model.setProductName(list.get(i).getProductName());
                        model.setProductImage(list.get(i).getAdvPic());
                        model.setProductNumber((int) list.get(i).getQuantity());
                        model.setPrice1(list.get(i).getPrice1());
                        model.setPrice2(list.get(i).getPrice2());
                        model.setPrice3(list.get(i).getPrice3());
        ...
        new Xutil().post("808040", object.toString(), new Xutil.XUtils3CallBackPost() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    model = gson.fromJson(jsonObject.toString(), new TypeToken<ShoppingCartModel>() {
                    }.getType());
    ...
    public void getTotalPrice() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).isChoose()) {
                rmb = sums(rmb, (list.get(i).getPrice1()*((int) list.get(i).getQuantity())));
                gwb = gwb + (list.get(i).getPrice2()*((int) list.get(i).getQuantity()));
                qbb = qbb + (list.get(i).getPrice3()*((int) list.get(i).getQuantity()));
            }
        }
